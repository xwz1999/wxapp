	...
	<view>
		...
		<view class="code-box bg-white">
			<view class="code-top">
				<view class="flex justify-center align-center" style="margin-bottom: 15rpx;">
					<image :src="IMAGE_URL + '/shop/left.png'" mode="widthFix"></image>
					<view style="padding: 0 20rpx;font-weight: 700;">专属邀请码</view>
					<image :src="IMAGE_URL + '/shop/right.png'" mode="widthFix"></image>
				</view>
		...
		<view class="steps-box bg-white">
			<view class="flex justify-center align-end" style="padding: 15rpx 0;">
				<image :src="IMAGE_URL +'/shop/left1.png'" mode="widthFix"></image>
				<view class="step-title">简单三步 立享财富</view>
				<image :src="IMAGE_URL + '/shop/right2.png'" mode="widthFix"></image>
			</view>
			<view class="steps-con flex justify-center">
				<view class="flex flex-direction align-center">
					<image :src="IMAGE_URL + '/shop/icon01.png'" mode="widthFix"></image>
					<view class="">分享链接</view>
					<view class="">给好友</view>
				</view>
				<view class="line"></view>
				<view class="flex flex-direction align-center">
					<image :src="IMAGE_URL + '/shop/icon02.png'" mode="widthFix"></image>
					<view class="">好友打开链接</view>
					<view class="">注册信息</view>
				</view>
				<view class="line"></view>
				<view class="flex flex-direction align-center">
					<image :src="IMAGE_URL + '/shop/icon03.png'" mode="widthFix"></image>
