<template>
	<view>
		...
		<!-- 待审核 -->
		<view class="msg-box bg-white" v-if="message.status==1&&message.returnStatus==1">
		...
		<!-- 申请未通过 -->
		<view class="msg-box bg-white" v-if="message.status==7&&message.returnStatus==2">
			<view class="flex" style="line-height: 50rpx;padding-bottom: 20rpx;">
				<text class="text-black" style="font-weight: 900;font-size: 32rpx;">{{message.subtitle}}</text>
			</view>
		...
		<!-- 申请通过，要求用户寄回 -->
		<view class="msg-box bg-white" v-if="message.status==2&&message.returnStatus==3">
			<view class="flex" style="line-height: 50rpx;padding-bottom: 20rpx;">
				<text class="text-black" style="font-weight: 900;font-size: 32rpx;">{{message.subtitle}}</text>
			</view>
		...
		<!-- 用户已寄回，等待平台收货确认 -->
		<view class="msg-box bg-white" v-if="message.status==3&&message.returnStatus==4">
			<view class="flex" style="line-height: 50rpx;padding-bottom: 20rpx;">
				<text class="text-black" style="font-weight: 900;font-size: 32rpx;">{{message.subtitle}}</text>
			</view>
		...
		<view class="msg-box bg-white" v-if="message.status==4&&message.returnStatus==3">
			<view class="flex" style="line-height: 50rpx;padding-bottom: 20rpx;">
				<text class="text-black" style="font-weight: 900;font-size: 32rpx;">{{message.subtitle}}</text>
			</view>
			<view class="des">若买家超时未填写物流信息，则系统将自动关闭退货请求。</view>
		...
		<!-- 退款成功 -->
		<view class="msg-box bg-white" v-if="message.status==5&&message.returnStatus==5">
			<view class="flex" style="line-height: 50rpx;padding-bottom: 20rpx;">
				<text class="text-black" style="font-weight: 900;font-size: 32rpx;">{{message.subtitle}}</text>
		...
		<!-- 售后关闭 -->
		<view class="msg-box bg-white" v-if="message.status==7&&message.returnStatus==6">
			<view class="flex" style="line-height: 50rpx;padding-bottom: 20rpx;">
				<text class="text-black" style="font-weight: 900;font-size: 32rpx;">{{message.subtitle}}</text>
			</view>
