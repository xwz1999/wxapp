	...
	<view class="page">
		<scroll-view class="scrollList" scroll-y :scroll-into-view="scrollViewId" :style="{height:winHeight+'px'}">
			<view class="search-bar">
				<view class="search-bar-form">
					<view class="search-bar-box">
						...
						<input confirm-type="search" class="search-bar-input" placeholder="输入城市名称或首字母查询" placeholder-class="phcolor" :value="inputVal" :focus="inputShowed" @input="inputTyping" />
			...
			<view class="tui-list search-result" v-if="inputShowed">
				<view class="tui-list-cell" hover-class="tui-list-cell-hover" v-for="(item,index) in searchResult" :key="index" @tap="selectCity" :data-name="item" :hover-stay-time='150'>
			...
			<view v-if="!inputVal">
				<view class="current-city">
					...
					<view class="city-name flex justify-between">
						<view @tap="selectCity" :data-name="localCity" style="font-size: 36rpx;">
							<text class="cuIcon-location"></text>{{localCity}}
						</view>
						<button v-if="showBtn" class="text-red set-btn" open-type="openSetting" @opensetting="getLocation"><i class="iconfont icontubiao"></i>重新定位</button>
						<button v-else class="text-red set-btn" @tap="getLocation">
							<i class="iconfont icontubiao"></i>重新定位
						</button>
					</view>
				</view>
				<view class="hot-city">
					...
					<view class="city-names">
						<view class="city-name-item" v-for="(item,index) in hotCity" :key="index" hover-class="tap-city" :hover-stay-time="150" @tap="selectCity" :data-name="item">{{item}}</view>
					</view>
				</view>
				<view class="tui-list city-list">
					<block v-for="(list,index) in lists" :key="index" v-if="list.data[0]">
						...
						<view class="tui-list-cell" hover-class="tui-list-cell-hover" v-for="(item,index2) in list.data" :key="index2" @tap="selectCity" :data-name="item.cityName" :hover-stay-time='150'>
