	...
	<view class="">
		<view class="top-container bg-white">
			<view class="top-info-box flex align-center">
				<view class="avatar">
					<u-lazy-load threshold="-100" :image="IMAGE_URL+info.headImgUrl" :index="index1" :error-img="IMAGE_URL + '/wxapp/null05.png'" 
		...
		<view class="dynamic-container bg-white" v-if="currentIndex==0">
			<view class="null flex flex-direction align-center" style="margin-top: 150rpx;" v-if="isNull1">
				<image :src="IMAGE_URL + '/wxapp/null05.png'"  style="width: 200rpx;" mode="widthFix"></image>
					...
					<view class="flex justify-between">
						...
						<view class="flex-sub clear item-con">
							<navigator url="/packageA/videoDetail/videoDetail" class="cover-pic" @tap="getVideoDetail(item)">
								<u-lazy-load threshold="-100" :image="item.short.cover_url" :index="index" borderRadius="10" :error-img="IMAGE_URL + '/wxapp/null05.png'"  :loading-img="IMAGE_URL + '/null05.png'" ></u-lazy-load>
							...
							<view class="goods-container flex justify-between" @tap="toDetail(item.goods.id)">
								<view class="goods-pic">
									<u-lazy-load threshold="-100" :image="IMAGE_URL+item.goods.mainPhotoURL" :index="index" borderRadius="10"
									 height="120" :error-img="IMAGE_URL + '/null05.png'"  :loading-img="IMAGE_URL + '/wxapp/null05.png'"  img-mode="aspectFill"></u-lazy-load>
								</view>
				...
				<view class="item" v-for="(item,index) in videos" :key="index">
					...
					// url: "/pages/livePlayback/livePlayback?id=" + id
							...
							<view class="cover-pic" @tap="toLivePlayback(item.id)">
								<u-lazy-load threshold="-100" :image="IMAGE_URL+item.cover" :index="index" borderRadius="10" :error-img="IMAGE_URL + '/wxapp/null05.png'"  :loading-img="IMAGE_URL + '/wxapp/null05.png'" ></u-lazy-load>
								<view class="mask flex flex-direction justify-center align-center">
									<text class="cuIcon-videofill text-white"></text>
								</view>
							</view>
