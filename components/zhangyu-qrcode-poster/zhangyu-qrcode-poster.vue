	...
	export default{
		...
		methods:{
			...
			async __init(){
				...
				context.fillRect(0, 0, this.convert_length(750), this.convert_length(750))
				// this.canvasW = this.convert_length(750);
				// this.canvasH = this.convert_length(1000);
				//设置画布背景透明
				// this.ctx.setFillStyle('rgba(255, 255, 255, 0)')
				//设置画布大小
				// this.ctx.fillRect(0,0,this.canvasW,this.canvasH)
				// //绘制圆角背景
				// this.drawRoundRect(this.ctx, 0, 0, this.canvasW, this.canvasH,0,'#FFFFFF')
				// //获取标题图片
				// let headerImg = await this.getImageInfo(this.headerImg)
				// let hW = this.convert_length(500);
				...
				// //绘制副标题
				// this.ctx.setFontSize(this.convert_length(26));
				...
				// }
				// //绘制价格
				// this.ctx.setFontSize(this.convert_length(38));
				...
				// this.ctx.setFillStyle('#858585');
				// this.ctx.fillText('长按识别图中“馋么”小程序',this.convert_length(60),(((this.canvasW-hW) / 2) + hH + 150))
				// //底部广告
