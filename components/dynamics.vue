		...
		<view class="find-container" v-else>
			<view class="dynamic-item" v-for="(item1,index1) in dynamics" :key="index1">
				<view class="bg-white flex justify-between" style="padding: 30rpx;">
					<view class="avatar">
						<u-lazy-load threshold="-100" :image="IMAGE_URL+'/wxapp'+item1.headImgUrl" :index="index1" :error-img="IMAGE_URL + '/wxapp/null05.png'"  height="80" border-radius="40" img-mode="aspectFill"></u-lazy-load>		
					</view>
